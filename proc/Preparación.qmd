...
-   Medidas de tendencia central tales como la: Media (mean) y el Rango (range)\[^1\]1\[^1\]
...
A partir de los resultados obtenidos podemos interpretar lo siguiente, estos nos demuestran que la mayoría de los encuestados no presentan mayores intenciones a la hora de preguntarles si tienen planeado realizar un cambio de vivienda, obteniendo una media de un 2.93 de una escala de 1 a 4, lo que nos induce a pensar que hay una cierta estabilidad residencial, esta cierta estabilidad se ve  motivada producto del alto sentido de pertenencia, identificación con el barrio y los vecinos teniendo valores en sus medias de 3.63 y 3.73 los cuales actúan como un seguro ante el sentimiento de querer realizar un cambio de vivienda. 

Por otra parte, los niveles de satisfacción con atributos en cuanto al entorno y la vivienda inciden en la percepción individual, los encuestados muestran cierta conformidad a la hora de preguntarles sobre el tamaño y calidad de la vivienda, la cercanía que tienen con amigos, familiares, colegios y conectividad en donde sus valores en la media van desde 3.2 a 3.78 en escalas de 1 a 5, los cuales también le agrega cierto peso al querer mantenerse en su vivienda actual. 

Ahora si abordamos las variables que podrían considerarse dentro del término de problemáticas al interior del barrio, estas no son indicadores del todo negativos variables como la frecuencia de ruidos molestos, amenazas entre vecinos, y problemas con la basuras presentan valores bajos que van desde 1.3 a 2, ahora si nos vamos a las variables que abordan la frecuencia de problemas más extremos como robos, peleas callejeras o el tráfico de drogas muestran valores un poco más altos que los anteriores que van desde un 1.9 hasta un 2.4, siendo este valor más alto el de la frecuencia del tráfico de drogas, esto también se ve reflejado en la variable en la satisfacción del barrio en cuanto a su seguridad en donde su media es de un 3.2  en una escala de 1 a 5, lo cual nos engloba de manera positiva que las personas en su sector se sienten más seguras que inseguras. Estas variables claramente inciden de manera más directa a la percepción que tienen los residentes en cuanto a su entorno debido a que los impacta de forma más fuerte y evidente. 

Como conclusión podemos decir que la mayoría de los encuestados no presentan fuertes incidencias en querer realizar un cambio de vivienda debido a que se sienten bastantes cómodos en cuanto a sentimientos positivos producidos por el barrio como la identificación del barrio y su gente, además también una valoración positiva en las oportunidades entregadas por el sector tanto en su conectividad, la cercanía a áreas verdes, limpieza, cercanía con familia o amigos, los cuales al también tener valores altos cumplen un rol importante, además al tener valores que no son del todo altos en cuanto a variables que entrarían en una categoría exposición al riesgo, le suma a que los individuos no presenten mayores intenciones de querer llevar a cabo un cambio en sus residencias. 
